...
/*
#define BUTTON_PIN1  2        // Define the button pin1 for TImerPuase
#define BUTTON_PIN2  5         // Define the button pin2 for Change the State
#define BUTTON_PIN3   5        // Define the button pin3 for Increment
*/
